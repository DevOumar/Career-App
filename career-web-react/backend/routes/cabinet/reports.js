...
export function registerCabinetReportsRoutes(app) {
  const {
...
app.get("/api/cabinet/reports", async (req, res) => {
  try {
...
app.post("/api/cabinet/reports/generate", async (req, res) => {
  try {
