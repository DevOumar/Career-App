...
export function UiIcon({ name, className = "" }) {
  const map = {
    ...
    code: (
      <path
        d="M7.7 5.3a1 1 0 00-1.4 0l-4 4a1 1 0 000 1.4l4 4a1 1 0 001.4-1.4L4.42 10l3.28-3.3a1 1 0 000-1.4zm4.6 0a1 1 0 000 1.4L15.58 10l-3.28 3.3a1 1 0 101.4 1.4l4-4a1 1 0 000-1.4l-4-4a1 1 0 00-1.4 0z"
        fill="currentColor"
      />
    ),
    plus: (
