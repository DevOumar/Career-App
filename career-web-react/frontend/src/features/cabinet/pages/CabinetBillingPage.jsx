...
// Espace Cabinet › Facturation : historique des paiements de la licence du
// cabinet (GET /api/billing/transactions), dans la charte de la
    ...
    <section className="admin-finance">
      <header className="module-header admin-accounts-header">
        <div>
          ...
          <p>{t("Historique des paiements de la licence de votre cabinet.", "Payment history for your firm's license.")}</p>
        </div>
      </header>
