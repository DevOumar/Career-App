...
export const CV_COPY = {
  fr: {
    import: {
      ...
      uploadBadFormat: "Format non pris en charge : importez un PDF, DOCX ou TXT (un ancien .doc doit d'abord être enregistré en .docx).",
      ...
      formats: "Formats acceptés : pdf, docx, txt",
  ...
  en: {
    import: {
      ...
      uploadBadFormat: "Unsupported format: import a PDF, DOCX or TXT file (save an old .doc as .docx first).",
      ...
      formats: "Accepted formats: pdf, docx, txt",
      history: "CV history",
