  ...
  const copy =
    language === "en"
      ? {
          ...
          language: "Language",
          currency: "Currency",
          currencyHint: "Prices are billed in euros and shown in your currency using the European Central Bank reference rate of the day.",
          theme: "Color theme",
      ...
      : {
          ...
          language: "Langue",
          currency: "Devise",
          currencyHint: "Les prix sont facturés en euros et affichés dans votre devise au taux de référence du jour de la Banque centrale européenne.",
